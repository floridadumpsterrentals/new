      ...
      <section className="bg-zinc-950 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            ...
            <a
              href={`tel:${phonePlain}`}
              className="inline-flex items-center rounded-lg border border-zinc-700 px-5 py-2.5 text-sm font-semibold text-white hover:border-zinc-500"
            >
              Call {PHONE}
            </a>
          </div>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-3">
            <div className="text-center">
              ...
              <p className="mt-1 text-xs text-zinc-500">Order by noon, delivered today across most of Florida.</p>
            </div>
            <div className="text-center">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-green-100 text-green-600">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
              ...
              <p className="mt-1 text-xs text-zinc-500">Flat-rate pricing. The quote you get is the price you pay.</p>
            </div>
            <div className="text-center">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-green-100 text-green-600">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
              ...
              <p className="mt-1 text-xs text-zinc-500">1,247+ reviews. Florida&apos;s top-rated dumpster rental service.</p>
            </div>
          </div>
        </div>
      </section>
